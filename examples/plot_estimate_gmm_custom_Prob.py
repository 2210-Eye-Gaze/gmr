...
for i in np.linspace(-3,4, SAMPLES):
    ...
    p = p.reshape(*x.shape)
    plt.contourf(x, y, p, colors=('#FEE89F', '#D0F87C', '#58F5A9', '#19E5E3', '#41B0F1', '#3C7DE4', '#2B4BE6', '#08249D'))
    s = [2] * 100
    ...
    interception_x = i
    plt.axvline(x=interception_x, c='y')
    ...
    plt.axhline(y=interception_y, c='orange')
